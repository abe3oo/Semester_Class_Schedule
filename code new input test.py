...
courses = {
    ...
    'نظریه محاسبه': {'inputs': [1404], 'sections_needed': 2, 'group': 'علوم_کامپیوتر', 'units': 3}
}
...
professors = {
    'حسینی نیا': {
        ...
        'available_times': [(0, 8, 10), (2, 10, 12)],  # اضافه کردن زمان‌ها
        'section_range': (2, 2)
    },
    'دهیار': {
        'group': 'هیات_علمی',
        'teachable_courses': ['فیزیک1'],
        'available_times': [(1, 13, 15), (2, 13, 15)],  # اضافه کردن زمان‌ها
        'section_range': (2, 2)
    },
    'نصیرزاده': {
        'group': 'هیات_علمی',
        'teachable_courses': ['آماراحتمال1'],
        'available_times': [(3, 13, 15), (4, 8, 10)],  # اضافه کردن زمان‌ها
        'section_range': (2, 2)
    },
    'روشن ضمیر': {
        'group': 'هیات_علمی',
        'teachable_courses': ['پایگاه داده', 'هوش مصنوعی'],
        'available_times': [(1, 15, 17), (3, 13, 15), (1, 17, 19), (3, 15, 17)],  # اضافه کردن زمان‌ها
        'section_range': (2, 4)
    },
    'نعمت الهی': {
        'group': 'هیات_علمی',
        'teachable_courses': ['ماتریس', 'ساختمان داده'],
        'available_times': [(0, 13, 15), (1, 13, 15), (1, 10, 12), (2, 13, 15)],  # اضافه کردن زمان‌ها
        'section_range': (1, 4)
    },
    'مصلحی': {
        'group': 'هیات_علمی',
        'teachable_courses': ['دیفرانسیل'],
        'available_times': [(1, 10, 12), (2, 13, 15)],  # اضافه کردن زمان‌ها
        'section_range': (1, 2)
    },
    'لطفی پور': {
        'group': 'هیات_علمی',
        'teachable_courses': ['آنالیز ریاضی'],
        'available_times': [(2, 13, 15), (4, 8, 10)],  # اضافه کردن زمان‌ها
        'section_range': (1, 2)
    },
    'سپاسیان': {
        'group': 'هیات_علمی',
        'teachable_courses': ['بهینه سازی خطی'],
        'available_times': [(2, 15, 17), (3, 15, 17), (2, 10, 12), (3, 10, 12)],  # اضافه کردن زمان‌ها
        'section_range': (1, 2)
    },
    'عبدالهی': {
        'group': 'هیات_علمی',
        'teachable_courses': ['نظریه محاسبه', 'مباحث'],
        'available_times': [(4, 8, 10), (2, 8, 10), (4, 10, 12), (3, 8, 10)],  # اضافه کردن زمان‌ها
        'section_range': (2, 4)
    }
}
